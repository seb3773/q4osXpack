...
rota
sudo tar -zcvf "backups/$now/konquerorrc.tar.gz" $TDEHOME/share/config/konquerorrc > /dev/null 2>&1
rota
...
kwriteconfig --file $TDEHOME/share/config/kdeglobals --group General --key background "255,255,255"
...
sudo kwriteconfig --file /root/.trinity/share/config/kdeglobals --group General --key background "255,255,255"
