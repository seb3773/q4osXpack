...
mkdir -p "$HOME/wine_mp3tag_setup/files"
cd "$HOME/wine_mp3tag_setup/files"
base_url="https://raw.githubusercontent.com/seb3773/wine_mp3tag/main"


wget $base_url/files/$setupfile
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/mp3tag.desktop
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/mp3tag.png
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/mp3tag.sh
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
cd ..
wget wget $base_url/install_mp3tag.sh
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
dcop "$dcopRef" close
...
*you can remove \"$HOME/wine_mp3tag_setup\" folder if you want.
</font>
"
