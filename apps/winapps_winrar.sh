...
mkdir -p "$HOME/wine_winrar_setup/files"
cd "$HOME/wine_winrar_setup/files"
base_url="https://raw.githubusercontent.com/seb3773/wine_winrar/main"


wget $base_url/files/$setupfile
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/winrar.desktop
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/winrar.png
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/winrar.sh
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
wget $base_url/files/rarreg.key
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
cd ..
wget wget $base_url/install_winrar.sh
dcop "$dcopRef" setProgress $filenumber;((filenumber++))
dcop "$dcopRef" close
...
kdtext="<font style='color:#ac6009'><strong>⏺ q4osXpack winapps ⏺</strong></font><br><br>
═══════════════════════════<br>
<em>WinRar installed.</em><br><br>
*you can remove \"$HOME/wine_winrar_setup\" folder if you want.
</font>
"
